...
using PxOperations.Domain.HealthChecks.Rules;
using PxOperations.Domain.Projects;
using PxOperations.Domain.Rules;

namespace PxOperations.Domain.HealthChecks;

public sealed class HealthCheck : AggregateRoot<int>
{
    private HealthCheck() : base(default) { }
